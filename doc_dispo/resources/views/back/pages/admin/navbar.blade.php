        ...
        <form action="" method="post" id="" enctype="multipart/form-data">
            ...
            <div class="body">
                ...
                @endif
                    ...
                    <input type="text"  class="form-control" value="9" name="id_partie" hidden>
                    ...
                    <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  class="form-control" value="{{ $entite->texte }}" required name="texte" placeholder="Texte">
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary btn-round">{{$action}} une navbar</button>
                    </div>
                </div>
                    @endif
            </div>
